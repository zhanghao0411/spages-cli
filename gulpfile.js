...
gulp.task('copyjs', function() {
    return gulp.src(['app/static/js/html5.js', 'app/static/js/jquery.min.js'])
...
gulp.task('jsmin', function() {
    return gulp.src(['app/static/js/*.js', '!app/static/js/html5.js', '!app/static/js/jquery.min.js',
...
gulp.task('serve', function() {
    ...
    gulp.watch(['app/static/js/*.js', path.sass, 'app/*.html'], function() {
...
gulp.task('prod', function(cb) {
    runSequence('clean', 'copyimg',  'copyico',  'copyjs', 'cssmin', 'jsmin', 'rev', 'htmlmin')(cb);
});